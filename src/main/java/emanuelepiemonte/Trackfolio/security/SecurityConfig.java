...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, TokenFilter tokenFilter) throws Exception {
        ...
        httpSecurity.authorizeHttpRequests(req -> {
            ...
            req.requestMatchers("/movies/**", "/tv_series/**", "/anime/**", "/games/**", "/catalog/**", "/actors/**").permitAll();
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:5173", "https://trackfoliomanu.netlify.app"));
